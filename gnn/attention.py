...
class GlobalAttention(torch.nn.Module):
    ...
    def forward(self, x: Tensor, batch: Optional[Tensor] = None,ptr: Optional[Tensor] = None,
        ...
        gate = softmax(gate,None,ptr, num_nodes=size)
        out =  segment_csr(gate * x, ptr, reduce='add')
